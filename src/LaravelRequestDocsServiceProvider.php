...
use OmidZahed\LaravelRequestDocs\Commands\LaravelRequestDocsCommand;
use Route;
...
class LaravelRequestDocsServiceProvider extends PackageServiceProvider
{
    public function configurePackage(Package $package): void
    {
        ...
        Route::get(config('request-docs.url'), [\OmidZahed\LaravelRequestDocs\Controllers\LaravelRequestDocsController::class, 'index'])
